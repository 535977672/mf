...
require_once 'model/builder/AlipayTradePayContentBuilder.php';//条码支付请求bizContent结构体
require_once 'service/AlipayTradeService.php';//当面付2.0服务实现，包括条码支付（带轮询）、扫码支付、消费查询、消费退款
